...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/upload/bootstrap.min.css">
    <!-- Generic page styles -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/upload/style.css">
    <!-- blueimp Gallery styles -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/upload/blueimp-gallery.min.css">
    <!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/upload/jquery.fileupload.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/upload/jquery.fileupload-ui.css">
    <!-- CSS adjustments for browsers with JavaScript disabled -->
    <noscript><link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/upload/jquery.fileupload-noscript.css"></noscript>
    <noscript><link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/upload/jquery.fileupload-ui-noscript.css"></noscript>
...
<script src="<?php echo base_url(); ?>assets/js/upload/jquery.min.js"></script>
...
<script src="<?php echo base_url(); ?>assets/js/upload/load-image.all.min.js"></script>
...
<script src="<?php echo base_url(); ?>assets/js/upload/jquery.blueimp-gallery.min.js"></script>
