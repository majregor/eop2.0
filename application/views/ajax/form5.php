...
<table border="0" width="100%">
    ...
    <tr>
        <td colspan="2">
            <textarea name="directionField" id="directionField"   <?php echo($controlStatus); ?> style="width: 100%" rows="11">
            ...
            <div align="left">
                <?php if($action != 'view'): ?>
                    <?php if($action=='add'): ?>
                        ...
                        <?php else: ?>
                        <input type="button" value="Update" id="btnsaveform5"/>
                    <?php endif; ?>
                <?php endif; ?>

                <input type="button" value="<?php echo(($action=='view')? 'Close': 'Cancel'); ?>" id="cancelBtn5"/>
            </div></td>
    </tr>
</table>
